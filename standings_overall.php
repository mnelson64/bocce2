...
<html lang="en">
<head>
<title><?=SITE_NAME?>: Overall Standings</title>
...
<div id="main">
  ...
  <div id="mainContentWrapper">
        ...
        <div id="subLeft">
            <h1><?=$_SESSION['sYear']?> Overall Standings</h1>
            ...
            <select name="gameYear" id="gameYear" onChange="window.location =this.options[this.selectedIndex].value">
             ...
             <option value="<?=$path?>StandingsOverall/<?=$y?>/" <?php if ($_SESSION['sYear'] == $y) echo "selected=\"selected\"" ?>><?=$y?></option>
             <?php } ?>
             </select>
             </div>
            ...
            <?php //print_r($teamArray);?>
            	...
            	<div class="standingsNight">
                    <div class="standingsHeading" id="standingsHeading"> Overall</div>
                    <div class="standingsBody" id="standingsBody">
                    <?php
					$teamScoresArray = array();
					// get teams for this night
					$team_query=sprintf("SELECT * FROM teams WHERE `teamYear` = '%s'",mysql_real_escape_string($_SESSION['sYear']));
					...
					?>
                            <div class="standingsEntryHeading">
                            	<div class="standingsEntryHeadingPA standingsEntryMargin">Rank</div>
