...
$content_query=sprintf("SELECT * FROM news WHERE newsURL = '%s'",$_GET['newsURL']);
...
<div id="main">
  ...
  <div id="mainContentWrapper">
        ...
        <div id="subLeft">
            <h1><?=stripslashes($row_content_set['newsHeadline'])?></h1>
            <?=stripslashes($row_content_set['newsArticle'])?>
            <?php if ($row_content_set['newsEmbed'] != '') { ?>
            <div class="video-container">
            <?php echo stripslashes($row_content_set['newsEmbed']);?>
            </div>
            <?php } ?>
            <div id="newsBackLink"><a href="<?=$path?>News-Events/"><< Back to News</a></div>
