<?php
	...
	$mcFileManagerConfig['filesystem.extensions'] = "gif,jpg,htm,html,pdf,zip,txt,php,png,swf,dcr,mov,qt,ram,rm,avi,mpg,mpeg,asf,flv,xlsx,docx";
	...
	$mcFileManagerConfig['upload.extensions'] = "gif,jpg,png,pdf,zip,xlsx,docx";
